<template>
    <div id="container">
        ...
        <div id="cards">
            <div>
                <p class="top">较昨日<span style="color: red;">{{ info.currentConfirmedIncr < 0 ? info.currentConfirmedIncr
                        : '+' + info.currentConfirmedIncr
                }}</span>
                </p>
            ...
            <div>
                <p class="top">较昨日<span style="color: brown;">{{ info.suspectedIncr < 0 ? info.suspectedIncr : '+' +
                        info.suspectedIncr
                }}</span>
                </p>
                <p class="middle" style="color: brown;">{{ info.suspectedCount }}</p>
                <p class="bottom">累计境外输入</p>
            </div>
            <div>
                <p class="top">较昨日<span style="color: darkgoldenrod;">{{ info.curedIncr < 0 ? info.curedIncr : '+' +
                        info.curedIncr
                }}</span>
                </p>
            ...
            <div>
                <p class="top">较昨日<span style="color: green;">{{ info.seriousIncr < 0 ? info.seriousIncr : '+' +
                        info.seriousIncr
                }}</span>
                </p>
                <p class="middle" style="color: green;">{{ info.seriousCount }}</p>
                <p class="bottom">现存无症状</p>
            </div>
        </div>
    </div>
</template>
